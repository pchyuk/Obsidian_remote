...
- Operability
	- Appropriateness, recognisability, Learnability, Ease of use, Helpfulness, Attractiveness, Technical accessibility, Compliance
- Security
	- Confidentially, integrity, Non-repudiation, Authenticity, Compliance
- Compatibility
	- Replaceability, Co-existence, Interoperability, Compliance
- Maintainability
	- Modularity, Reusability, Analyzability, Changeability, Modification, stability, Testability, Compliance
- Transferability