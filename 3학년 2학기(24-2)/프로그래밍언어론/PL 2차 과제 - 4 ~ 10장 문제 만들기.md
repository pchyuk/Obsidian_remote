...
- 바운드된 식별자: v2, v3
- 자유 식별자: v1
- v2는 함수의 매개변수로서 그 유효 범위는 함수 내에 제한되며, localVar는 함수 내부에서 정의된 지역 변수로서 그 유효 범위 또한 함수 내부입니다. 
- 반대로, globalVar는 함수 외부에서 정의되었으므로 자유 식별자로 간주됩니다. 
